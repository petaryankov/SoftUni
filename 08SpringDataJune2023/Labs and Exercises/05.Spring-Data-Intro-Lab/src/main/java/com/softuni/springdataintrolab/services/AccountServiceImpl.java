...
import com.softuni.springdataintrolab.models.Account;
import com.softuni.springdataintrolab.repositories.AccountRepository;
...
public class AccountServiceImpl implements AccountService {
    ...
    public void withdrawMoney(BigDecimal money, Long id) {
        ...
        if (accountOpt.isEmpty()) {
            throw new IllegalArgumentException("Account not existing");
        }
